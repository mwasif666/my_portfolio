            ...
            <div className="box-linear-animation position-relative z-1">
              <div className="row align-items-end py-60">
                <div className="col-lg-5 ps-lg-5 text-lg-start text-center">
                  <div className="position-relative mb-lg-0 mb-5 img-header-web">
                    <img
                      ...
                      <div className="col-7">
                        ...
                        <Marquee className="carouselTicker carouselTicker-left position-relative z-1 mt-lg-0 mt-8">
                          <ul className="carouselTicker__list ">
                            ...
                            <li className="carouselTicker__item custom-icon-add">
                              <Link
                                href="#"
                                className="brand-logo icon_60 icon-shape rounded-3"
                              >
                                <img
                                  src="assets/imgs/home-page-2/hero-1/Bootstrap_logo.png"
                                  alt="brand"
                                />
                              </Link>
                            </li>
                            <li className="carouselTicker__item custom-icon-add">
                              ...
                              >
                                <img
                                  src="assets/imgs/home-page-2/hero-1/jquery.svg"
                                  alt="brand"
                                />
                              </Link>
                            </li>
                            <li className="carouselTicker__item custom-icon-add">
                              ...
                              >
                                <img
                                  src="assets/imgs/home-page-2/hero-1/reacct js.png"
                                  alt="brand"
                                />
                              </Link>
                            </li>
                            <li className="carouselTicker__item custom-icon-add">
                              ...
                              >
                                <img
                                  src="assets/imgs/home-page-2/hero-1/php.png"
                                  alt="brand"
                                />
                              </Link>
                            </li>
                            <li className="carouselTicker__item">
                              ...
                              >
                                <img
                                  src="assets/imgs/home-page-2/hero-1/laravel.png"
                                  alt="brand"
                                />
                              </Link>
                            </li>
                            <li className="carouselTicker__item custom-icon-add">
                              ...
                              >
                                <img
                                  src="assets/imgs/home-page-2/hero-1/angular.png"
                                  alt="brand"
                                />
                              </Link>
                            </li>
