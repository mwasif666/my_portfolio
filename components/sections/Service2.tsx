                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          <span className="text-secondary-2">PHP</span>, and
                          modern frameworks like React js / Next js and Angular.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          <span className="text-secondary-2">SQLite</span>,{" "}
                          <span className="text-secondary-2">Firebase</span>,
                          and <span className="text-secondary-2">Redis</span>.
                          Additionally, developing backend solutions using{" "}
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          with <span className="text-secondary-2">Node.js</span>
                          ...
                          <span className="text-secondary-2">Redis</span>,{" "}
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          tailored to your business needs, using{" "}
                          <span className="text-secondary-2">PHP</span>,{" "}
                          <span className="text-secondary-2">Laravel</span>,{" "}
                          <span className="text-secondary-2">
                            WordPress (WooCommerce)
                          </span>
                          , <span className="text-secondary-2">Shopify</span>,{" "}
                          <span className="text-secondary-2">React.js</span>,{" "}
                          <span className="text-secondary-2">.NET</span>,{" "}
                          <span className="text-secondary-2">MongoDB</span>, and{" "}
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
