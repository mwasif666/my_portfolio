...
const swiperOptions = {
  ...
  autoplay: {
    delay: 5000,
    disableOnInteraction: false, // یوزر انٹریکشن کے بعد بھی autoplay چلے گا
    pauseOnMouseEnter: true, // Hover کرنے پر autoplay رک جائے گا
  },
  pagination: {
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                              <h4 className="text-linear-4">
                                Online Book Reading & Publishing Platform
                              </h4>
                              <p>
                                Developed a dynamic online learning platform
                                with course management, interactive quizzes, and
                              ...
                              <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                                ...
                                <Link
                                  href="https://github.com/mwasif666"
                                  target="_blank"
                                  className="text-300 border-bottom border-1 px-2 pb-2 link-hover"
                                >
                                  <svg
                        ...
                        <div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                          <div className="row">
                            <div className="col-lg-5 image-container">
                              <img
                                className="w-100 img-web"
                                src="assets/imgs/home-page-2/projects/img-2.png"
                                alt="zelio"
                              />
                            </div>
                            <div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                              <h4 className="text-linear-4">
                                Learn Onsite Trading <br />
                                with Expert-Led Classes
                              </h4>

                              <p>
                                Developed an online learning platform with
                                course management, quizzes, and progress
                                tracking. This platform enables students to
                                enroll in live trading classes, access recorded
                                sessions, take interactive quizzes, and track
                                their learning progress in real-time.
                              </p>
